...
namespace Banka.Models
{
    ...
    public record PosudbaDTORead (int sifra_posudbe, int sifra_kredita, string vrsta_kredita, int sifra_komitenta, DateTime datum_podizanja, DateTime datum_vracanja, decimal iznos, string valuta_kredita, decimal kamata);
